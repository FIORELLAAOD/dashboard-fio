...
export default function PageFaqs() {
    ...
    puede impulsar la eficiencia y el éxito de tu empresa. </p>
    </div>
    <AccordionFaqs/>
    </div>
    )
