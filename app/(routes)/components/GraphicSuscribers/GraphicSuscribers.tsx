...
import{ Area, AreaChart, ResponsiveContainer, Tooltip, XAxis,YAxis  
} from 'recharts'
import { dataGraphic } from "./GraphicSuscribers.data"
export function GrapicSuscribers(){
    ...
    <div className="mt-5">
        ...
        <div className="h-[350px]">
            <ResponsiveContainer width="100%" height="100%">
                <AreaChart width={730} height={250} data={dataGraphic}
                margin={{top:10, right:30, left:0, bottom:0}}
                >
                    <defs>
                        <linearGradient id="colorUv" x1="0"  y1="0" x2="0" y2="1" >
                            <stop offset="5%" stopColor="#9887CFD" stopOpacity={0.8}/>

                            <stop offset="95%" stopColor="#9887CFD" stopOpacity={0}/>
